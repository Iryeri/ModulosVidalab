...
<div class="container">
    <div class="row justify-content-center">
        ...
        <br>
        <center><a href="/pruebas/agregar" class="btn btn-dark">Registrar Análisis</a>    |   <a href="/paquetes/" class="btn btn-dark">Desplegar paquetes de análisis</a>    |    <a href="/catalogos" class="btn btn-dark">Ir al catálogo</a>    |    <a href="/home" class="btn btn-dark">Ir al menú principal</a></center>
    </div>
</div>
@endsection