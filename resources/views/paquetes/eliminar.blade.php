            ...
            <form action="/paquetes/{{$paquete->idDelPaquete}}" method="POST">
                ...
                <div class="row">
                    ...
                    <label for="exampleFormControlSelect1">Código</label>
                        <input type="text" class="form-control" name="codigoDelPaquete" readonly="codigoDelPaquete" value="{{$prueba->codigoDelPaquete}}"/> <br> 
                    </div>
                    <div class="col">
                        <label for="exampleFormControlSelect1">Nombre</label>
                        <input type="text" class="form-control" name="nombreDelPaquete" readonly="nombreDelPaquete" value="{{$prueba->nombreDelPaquete}}"/> <br> 
                    </div>
                    <div class="col">
                        <label for="exampleFormControlSelect1">Costo</label>
                        <input type="text" class="form-control" name="costoDelPaquete" readonly="costoDelPaquete" value="{{$prueba->costoDelPaquete}}"/> <br> 
                    </div>
                </div>

                <label for="exampleFormControlSelect1">Descripción del paquete</label>
                <textarea name="descripcionDelPaquete" class="form-control" cols="30" rows="5" readonly="descripcionDelPaquete">{{$prueba->descripcionDelPaquete}}</textarea> <br> 
