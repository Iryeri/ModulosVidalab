    ...
    <div class="card"><!--BOOTSTRAP 4 -> COMPONENT-CARD-->
        ...
        <div class="card-body"><!--BOOTSTRAP 4 -> COMPONENT-CARD-->
            ...
            <form action="/empresas" method="POST"><!--FORMULARIO PROPIO-->
                ...
                <input type="text" class="form-control" placeholder="Escriba un número telefónico para contacto" name="numeroDeTelefonoDeLaEmpresa" /> <br> <!--BOOTSTRAP 4 -> COMPONENT-FORMS-->
                @error('numeroDeTelefonoDeLaEmpresa')
                    <div class="alert alert-danger">{{$message}}</div>
                @enderror

                <label for="exampleFormControlSelect1">Correo electrónico</label>
                <input type="text" class="form-control" placeholder="Escriba un correo electrónico para contacto" name="correoElectronicoDeLaEmpresa" /> <br> <!--BOOTSTRAP 4 -> COMPONENT-FORMS-->
                @error('correoElectronicoDeLaEmpresa')
                    <div class="alert alert-danger">{{$message}}</div>
                @enderror

                <label for="exampleFormControlSelect1">Ubicación (dirección exacta)</label>
                <textarea name="direccionDeLaEmpresa" class="form-control" cols="30" rows="5" placeholder="Escriba la dirección exacta de la empresa"></textarea> <br> <!--BOOTSTRAP 4 -> COMPONENT-FORMS-->
